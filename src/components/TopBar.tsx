            ...
            <div className="container mx-auto px-3 md:px-6 h-auto py-2 md:py-0 md:h-12 flex flex-col md:flex-row items-center justify-between text-xs md:text-sm gap-2 md:gap-0">
                ...
                <div className="flex items-center gap-4 md:gap-8 w-full md:w-auto justify-center md:justify-start">
                    <Link
                        ...
                        aria-label="Call us"
                    >
                        <Phone className="h-3 w-3 md:h-4 md:w-4 text-orange-600 group-hover:scale-110 transition-transform" />
                    ...
                    >
                        <svg
                            viewBox="0 0 24 24"
                            className="h-3 w-3 md:h-4 md:w-4 fill-orange-600 text-orange-600 group-hover:scale-110 transition-transform"
                ...
                <div className="hidden md:flex items-center gap-4">
                    <span className="hidden sm:inline text-orange-800 font-medium mr-1 text-xs uppercase tracking-wider">Follow Us:</span>
                    <Link
                        href="#"
                        className="text-orange-600 hover:text-orange-800 transition-colors hover:-translate-y-0.5 transform duration-200"
                        aria-label="Facebook"
                    >
